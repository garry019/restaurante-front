<?php if(isset($_GET['parametro'])){ ?>
  <input type="hidden" id="clienteID" name="" value="<?php echo $_GET['vista']; ?>">
  <input type="hidden" id="clienteCode" name="" value="<?php echo $_GET['parametro']; ?>">
<?php } ?>
<div class="col-xs-12 all-contents content-liga text-center">
  ...
  <div class="row" style="padding:0 5px 5px 5px; background: #fff;">
    <div class="col-xs-12 formulario-liga">
      ...
      <form id="formLigaCompletar" class="form-horizontal">
